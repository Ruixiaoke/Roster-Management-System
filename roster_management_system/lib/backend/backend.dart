...
/// Functions to query TaskChoosedRecords (as a Stream and as a Future).
Stream<List<TaskChoosedRecord>> queryTaskChoosedRecord({
  ...
  bool singleRecord = false,
    ...
    queryCollection(
      TaskChoosedRecord.collection(parent),
...
Future<List<TaskChoosedRecord>> queryTaskChoosedRecordOnce({
  DocumentReference parent,
  Query Function(Query) queryBuilder,
  int limit = -1,
  bool singleRecord = false,
...
Future<FFFirestorePage<TaskChoosedRecord>> queryTaskChoosedRecordPage({
  DocumentReference parent,
  Query Function(Query) queryBuilder,
  DocumentSnapshot nextPageMarker,
  int pageSize,
